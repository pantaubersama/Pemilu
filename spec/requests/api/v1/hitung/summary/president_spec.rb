...
RSpec.describe "Persentase perhitungan presiden", type: :request do
  ...
  describe "[GET] /hitung/v1/summary/president/show?level=0" do
    ...
    it "success" do
      ...
      expect(json_response[:data][:percentage][:candidates][0][:total]).to eq(30)
      ...
      expect(json_response[:data][:percentage][:candidates][1][:total]).to eq(70)
  ...
  describe "[GET] /hitung/v1/summary/president/list?level=0" do
    ...
    it "sucess" do
      ...
      expect(json_response[:data][:percentages][0][:percentage][:candidates][0][:total]).to eq(70)
      ...
      expect(json_response[:data][:percentages][0][:percentage][:candidates][1][:total]).to eq(100)
      expect(json_response[:data][:percentages][0][:percentage][:candidates][1][:percentage]).to eq(50)
      expect(json_response[:data][:percentages][0][:percentage][:invalid_vote][:total]).to eq(30)
