class API::V1::Linimasa::JanjiPolitiks::Resources::JanjiPolitiks < API::V1::ApplicationResource
  ...
  resource "janji_politiks" do
    ...
    get do
      ...
      resources = JanjiPolitik.search(query, match: :text_middle, misspellings: false, load: true, page: (params.page || 1), per_page: (params.per_page || Pagy::VARS[:items]), order: { created_at: :desc }, where: build_conditions)
    ...
    get :me do
      ...
      resources = JanjiPolitik.search(query, match: :text_middle, misspellings: false, load: true, page: (params.page || 1), per_page: (params.per_page || Pagy::VARS[:items]), order: { created_at: :desc }, where: { user_id: current_user.id })
