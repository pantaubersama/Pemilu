class API::V1::Linimasa::Feeds::Resources::Feeds < API::V1::ApplicationResource
  ...
  resource "feeds" do
    ...
    get :pilpres do
      ...
      resources        = Feed.search(query, match: :text_middle, misspellings: false, load: true, page: (params.page || 1), per_page: (params.per_page || Pagy::VARS[:items]), order: { created_at: :desc }, where: build_conditions)
